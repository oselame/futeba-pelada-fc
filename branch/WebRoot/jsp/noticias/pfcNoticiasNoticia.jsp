...
<p>
	...
	<span class="style1">
		<bean:write name="noticiaForm" property="entidade.dtNoticiastring" />
	</span>
	...
	<logic:equal name="USUARIOLOGADO" value="true">
		<logic:equal name="TIPOUSUARIO" value="1">
			<html:button value="Editar" property="bntEditar" styleClass="bN" 
			   onclick="location.href='editarCadNoticia.do?cdNoticia=${noticiaForm.entidade.noticiaPK.cdNoticia}'" />
		</logic:equal>
	</logic:equal>
</p> 
